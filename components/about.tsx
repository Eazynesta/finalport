  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">Computer Science</span> as a
        major. During my course I worked on some interesting projects and
        finished them end-to-end. I soon found an interest as a software Developer.
        Primary Areas of my expertise are Web, Blockchain and Machine Learning. I also
      ...
      <p>
        <span className="italic">When I'm not coding</span>, I enjoy analyzing the financial markets, art, and biking. I also enjoy{" "}
